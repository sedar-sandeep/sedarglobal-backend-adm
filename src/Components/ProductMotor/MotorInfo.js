...
const Api_Productlov = 'admin/portal/ProMotor/product_lov';
...
class MotorInfo extends Component {
    ...
    render() {
        ...
        const columns = ['sr_no', 'PR_ITEM_DESC', 'MOTOR_TYPE_DESC', 'SPM_MIN_WIDTH', 'SPM_MAX_HEIGHT', 'MOTOR_DESC', 'SPM_VALANCE_APP_YN', 'SPM_CN_SPECIFIC_YN', 'SPM_ACTIVE_YN', 'actions'];
        const options = {
            perPage: PER_PAGE,
            headings: {
                sr_no: '#',
            ...
            <div>
                ...
                <WindowPanel rawHtml={
                    <div className="windowContent">
                        <ServerTable lov_url={Api_Productlov} addon={this.state.addonList} renderView={this.state.renderTable} columns={columns} url={url} options={options} bordered hover updateUrl hist_table="SITE_M_PRODUCT_MOTOR_HIST">
