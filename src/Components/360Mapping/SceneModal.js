...
class SceneModal extends Component {
    ...
    render() {
        ...
        let $imagePreview = setValue.scene_image?(<img src={setValue.scene_image} style={{ width: '100%' }} alt="Scene" />):(<div className="previewText"></div>);
        let $imagePreview1 = setValue.occ_image_path?(<img src={setValue.occ_image_path} style={{ width: '100%' }}  alt="Occ" />):(<div className="previewText"></div>);
