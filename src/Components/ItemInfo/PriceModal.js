...
class PriceModal extends Component {
  ...
  render(){
    ...
    const options = {
      ...
      sortable: ['product_desc', 'from_dt', 'upto_dt', 'active_yn'],
      ...
      <div>
        ...
        <WindowPanel rawHtml={
          <div className="windowContent">
                    <ServerTable renderView={this.state.priceRenderTable} columns={columns} url={`${url + `?item_info_id=` + this.state.item_info_id}`} options={options} addme={$button} bordered hover updateUrl hist_table="SITE_M_ITEM_PRICE_CN_HIST">
            {
                      ...
                      return (
                        <div className="form-control-sm" style={{ textAlign: 'center' }}>
                          <DropdownButton size="sm" id="dropdown-basic-button" title={<FontAwesomeIcon icon={faCog} />}>
                            ...
                            <Dropdown.Item><FontAwesomeIcon icon={faEdit} />Countrry Specific</Dropdown.Item>
