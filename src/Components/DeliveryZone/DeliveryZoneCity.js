...
import DeliveryZoneCityModal from "../DeliveryZone/DeliveryZoneCityModal";
...
class DeliveryZoneCity extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const columns = ['sr_no', 'ISO_1', 'SATE_PROVINCE', 'CITY','SCT_ACTIVE_YN', 'SCT_ZONE', 'MAIN_CITY', 'AREA','SAR_ACTIVE_YN','actions'];
        const options = {
            perPage: PER_PAGE,
            headings: {
                sr_no: '#',
                ISO_1: 'Country',
                SATE_PROVINCE: 'Sate/Province',
                CITY: 'City',
                SCT_ACTIVE_YN:'City Active',
                SCT_ZONE: "Delivery Zone",
                MAIN_CITY: "Main City",
                AREA: "Area",
                SAR_ACTIVE_YN:'Area Active'
            ...
            sortable: ['ISO_1', 'CITY', 'AREA', 'SCT_ZONE', 'SATE_PROVINCE'],
...
export default DeliveryZoneCity;