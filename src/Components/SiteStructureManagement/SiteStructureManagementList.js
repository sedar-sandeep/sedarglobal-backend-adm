	...
	render() {		
		...
		return (
			<>
				...
				<ServerTable searchType={this.props.searchType} columns={columns} slugUrl='admin/portal/structure/slug_lov' url={url} options={options} addme={$button} bordered hover updateUrl hist_table="SITE_M_STRUCTURE_HIST">
				{
