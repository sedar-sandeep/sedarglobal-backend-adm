                ...
                <Modal animation={false} size="xl" show={this.props.show} onHide={this.props.closeModal} >
                    <Modal.Header closeButton className="">
                        <Modal.Title id="modalTitle">
                            <span>   Product Steps <b>{this.state.mode === 'IS' ? 'Add' : 'Update'}</b> ({product_name})</span>
                    ...
                    <Modal.Body>
                        <Row>
                            <Col sm={12} dir={lang_code == 'ar' ? 'rtl' : 'ltr'}>
                                <Form noValidate onSubmit={this.handleSubmit} autoComplete="off">
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col className={lang_code == 'ar' ? 'd-none' : 'en'}>
                                            <Form.Group>
                                    ...
                                    <Form.Row>
                                        <Col md={2} className={lang_code == 'ar' ? 'd-none' : 'en'}>
                                            <Form.Group>
                                    ...
                                    <Form.Row>
                                        ...
                                        <Col style={{ marginBottom: '12px', marginLeft: '26px' }}>
                            ...
                            <Col sm={12}>
                                ...
                                <WindowPanel rawHtml={
                                    <div className="windowContent">
                                        <ServerTable renderView={this.state.filterRenderTable} columns={columns} url={url} options={options} addme={$button} bordered hover updateUrl hist_table="SITE_M_STEP_HIST">
                                            {
