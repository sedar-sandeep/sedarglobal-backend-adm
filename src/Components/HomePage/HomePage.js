...
class HomePage extends Component {
  ...
  reactDatatable = (pagination = this.state.initialPage) => {
    ...
    let slugname = this.state.slugname !== '' ? this.state.slugname : '';
  ...
  parentModel = (id, param, desc = null) => {
    if (param === 'E') {
      ...
      this.setState({ sysid: id, language: param, modalShow: true, mode: 'UP' });
    } else {
            ...
            <Modal animation={false} size="md" show={this.state.showmodal} onHide={this.confirmModal} >
              ...
              <Modal.Body>
                <Form>
                  <Form.Group>
                    ...
                    <div>
                      <Select
                        ...
                        defaultValue={{ value: this.state.pagename || '', label: this.state.pagename || '' }}
                  ...
                  <Form.Group className='position-relative zIndex-0'>
                    <Form.Check
                      type="switch"
                      id="ONE"
