...
class CityList extends Component {
    ...
    render() {
        ...
        const columns = ['sr_no', 'SCT_SCN_ISO', 'SST_DESC', 'SCT_DESC', 'SCT_ZONE', 'SCT_LOCALITY_YN', 'SCT_ACTIVE_YN', 'actions'];
        const options = {
            perPage: PER_PAGE,
            headings: {
                sr_no: '#',
                ...
                SCT_DESC: 'City',
                SCT_ZONE: "Delivery Zone",
                SCT_LOCALITY_YN: "Main City",
                SCT_ACTIVE_YN: 'Active'
            ...
            sortable: ['SCT_SCN_ISO', 'SST_DESC', 'SCT_DESC', 'SCT_ZONE', 'SCT_LOCALITY_YN', 'SCT_ACTIVE_YN'],
                                            ...
                                            return (
                                                <div className="form-control-sm" style={{ textAlign: 'center' }}>
                                                    <DropdownButton size="sm" id="dropdown-basic-button" title={<FontAwesomeIcon icon={faCog} />}>
                                                        <Dropdown.Item onClick={() => self.editRecord(row.SCT_CODE, 'en')}><FontAwesomeIcon icon={faEdit} /> Edit</Dropdown.Item>
                                                        <Dropdown.Item onClick={() => self.editRecord(row.SCT_CODE, 'ar')}><FontAwesomeIcon icon={faLanguage} /> Edit Language</Dropdown.Item>
                                                        <Dropdown.Item onClick={() => self.deletRecord(row.SCT_CODE)}><FontAwesomeIcon icon={faTrash} /> Delete</Dropdown.Item>
                                                    </DropdownButton>
                                                </div>
                                            );
                                        default:
